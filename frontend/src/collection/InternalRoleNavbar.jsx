...
export default function InternalRoleNavbar({
  ...
  return (
    <>
      <style>{`
        .irn-shell *{box-sizing:border-box}.irn-top{position:sticky;top:0;z-index:80;background:rgba(253,253,252,.985);border-bottom:1px solid rgba(189,207,206,.68);box-shadow:0 18px 44px rgba(7,59,63,.06);backdrop-filter:blur(18px)}.irn-inner{min-height:104px;display:flex;align-items:stretch;gap:6px;padding:0 12px 0 6px}.irn-brand{width:auto;min-width:190px;border:0;background:transparent;display:flex;align-items:center;gap:8px;padding:0 10px;cursor:pointer;flex-shrink:0}.irn-brand img{width:54px;height:54px;object-fit:contain}.irn-brand strong{display:block;font-family:Georgia,'Times New Roman',serif;font-size:31px;line-height:.95;font-weight:850;letter-spacing:.04em;color:#073B3F}.irn-brand small{display:block;margin-top:5px;color:#BB8958;font-size:10px;font-weight:900;letter-spacing:.24em;text-transform:uppercase}.irn-menu{flex:1;display:flex;justify-content:space-between;align-items:stretch;gap:0;min-width:0}.irn-group{position:relative;display:flex}.irn-trigger{border:0;background:transparent;min-width:0;padding:0 8px;color:#073B3F;font-family:Georgia,'Times New Roman',serif;font-size:13px;font-weight:850;letter-spacing:.02em;text-transform:uppercase;display:flex;align-items:center;justify-content:center;gap:5px;cursor:pointer;white-space:nowrap}.irn-trigger:hover{background:#F3F3F0;border-radius:999px}.irn-drop{position:absolute;top:100%;left:50%;transform:translateX(-50%) translateY(10px);min-width:292px;padding:24px 28px;background:rgba(253,253,252,.99);border:1px solid rgba(189,207,206,.8);box-shadow:0 26px 68px rgba(7,59,63,.14);border-radius:8px;opacity:0;visibility:hidden;pointer-events:none;transition:.18s ease;z-index:100}.irn-group:hover .irn-drop{opacity:1;visibility:visible;pointer-events:auto;transform:translateX(-50%) translateY(0)}.irn-title{display:flex;align-items:center;gap:12px;font-family:Georgia,'Times New Roman',serif;font-size:22px;font-weight:900;color:#073B3F;margin-bottom:18px}.irn-title span{font-size:24px;color:#BB8958}.irn-link{width:100%;border:0;background:transparent;padding:10px 0;text-align:left;color:#111817;font-size:14px;font-weight:780;display:flex;align-items:center;justify-content:space-between;gap:16px;cursor:pointer}.irn-link:hover{color:#0C4044;transform:translateX(3px)}.irn-badge{min-width:19px;height:19px;border-radius:999px;background:#C92035;color:#FDFDFC;font-size:10px;font-weight:900;display:inline-flex;align-items:center;justify-content:center;padding:0 6px}.irn-actions{display:flex;align-items:center;gap:3px;flex-shrink:0}.irn-action{min-width:0;min-height:42px;border:0;background:transparent;color:#0C4044;font-size:12px;font-weight:900;display:flex;align-items:center;justify-content:center;gap:5px;cursor:pointer;border-radius:999px;padding:0 9px;position:relative;white-space:nowrap}.irn-action:hover{background:#F3F3F0;box-shadow:0 12px 28px rgba(7,59,63,.08);transform:translateY(-1px)}.irn-action.danger{color:#C92035}.irn-action .irn-badge{position:absolute;top:8px;right:5px}@media(max-width:1200px){.irn-inner{display:block;padding:0}.irn-brand{width:100%;height:78px;justify-content:center}.irn-menu{justify-content:flex-start;overflow-x:auto;padding:0 16px;border-top:1px solid rgba(189,207,206,.45)}.irn-trigger{height:56px;min-width:158px}.irn-actions{overflow-x:auto;padding:10px 16px 14px}.irn-action{min-width:120px}}
      `}</style>
