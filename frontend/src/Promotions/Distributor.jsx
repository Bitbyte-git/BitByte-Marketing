...
export default function DistributorPromotions() {
  ...
  const runAction = async (userId, action) => {
    ...
    try {
      ...
      showToast(
        action === "approve" ? "Approved! Wholesale Dealer promoted to Distributor." : "Request rejected.",
  ...
  return (
    <div className="rp-page">
      <style>{`
        ...
        .rp-shell { width: calc(100% - 48px); max-width: 1360px; margin: 0 auto; padding: 40px 0 64px; box-sizing: border-box; }
        ...
        .rp-header p { margin: 6px 0 0; color: #7A8987; font-size: 13px; max-width: 640px; }
        ...
        .rp-table { width: 100%; border-collapse: collapse; font-size: 14px; min-width: 1100px; }
      ...
      <div className="rp-shell">
        ...
        <div className="rp-stats">
          ...
          <div className="rp-stat">
            <div className="rp-stat-label">Approved Distributors</div>
        ...
        <div className="rp-card">
          <div className="rp-card-head">
            <h2>Eligible Wholesale Dealers</h2>
          ...
          <div className="rp-table-wrap">
            <table className="rp-table">
              ...
              <tbody>
                {loading ? (
                  <tr className="rp-loading-row"><td colSpan={8}>Loading...</td></tr>
                ) : rows.length === 0 ? (
                      ...
                      <tr key={r.user_id}>
                        ...
                        <td>
                          <span
                            ...
                            onClick={() =>
                              navigate(`/promotions/sales-order-list?node_type=sub_dealer&user_id=${r.user_id}&list_type=customers&name=${encodeURIComponent(r.first_name + ' ' + r.last_name)}`)
                            }
                          >
                            {r.total_customers}
                          </span>
                        ...
                        <td>
                          <span
                            ...
                            style={{ cursor: 'pointer', textDecoration: 'underline' }}
                            onClick={() =>
                              navigate(`/promotions/sales-order-list?node_type=sub_dealer&user_id=${r.user_id}&list_type=retailers&name=${encodeURIComponent(r.first_name + ' ' + r.last_name)}`)
                            }
                          >
                            {r.total_retailers}
                          </span>
                        ...
                        <td>
                          <span
                            ...
                            style={{ cursor: 'pointer', textDecoration: 'underline' }}
                            onClick={() =>
                              navigate(`/promotions/sales-order-list?node_type=sub_dealer&user_id=${r.user_id}&list_type=wholesale_dealers&name=${encodeURIComponent(r.first_name + ' ' + r.last_name)}`)
                            }
                          >
                        ...
                        <td
                          ...
                          style={{ cursor: 'pointer', textDecoration: 'underline' }}
                          onClick={() =>
                            navigate(`/promotions/sales-order-list?node_type=sub_dealer&user_id=${r.user_id}&list_type=customers&order_filter=orders_only&name=${encodeURIComponent(r.first_name + ' ' + r.last_name)}`)
                          }
                        >
                          {money(r.total_value)}
                        </td>
      ...
      {confirmReject && (
        <div className="rp-modal-overlay" onClick={() => setConfirmReject(null)}>
          <div className="rp-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <p>
              {confirmReject.first_name} {confirmReject.last_name} ({confirmReject.sub_dealer_id}) will not
              be promoted to Distributor.
            </p>
